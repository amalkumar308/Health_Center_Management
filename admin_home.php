              ...
              <div style="color:#red  ;background-color:#071d36;opacity: 0.9; ">
                      ...
                      <?php
                        ...
                        echo "<caption style='color:#D7DA0F '> Availebel Doctors</capiton>";
                          echo "<tr style=' border-left: 6px solid red;color:#D7DA0F' align='center'><th>Name</th><th>Phone Number</th><th>Email</th><th>Address</th><th>Speciliest</th></tr>";
       
                         while($row=$result->fetch_array())
                           {
                            $a=1;
                            echo "<tr style=' border-left: 6px solid red; color:#D7DA0F' align='center'><form action='book.php' method='post'><td>Dr. $row[2] $row[3] $row[4]</td><td>$row[6]</td><td>$row[5]</td><td>$row[7]<br>$row[8]<br>$row[9]</td><td>$row[10]</td></tr>";
                           }
                       echo "</table>";
