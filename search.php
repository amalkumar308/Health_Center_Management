		...
		<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
			<div class="panel panel-info" >
				<div class="panel-heading">
					<div class="panel-title">Search Doctor</div>
				...
				<div style="padding-top:30px;" class="panel-body" >
					...
					<form id="loginform" class="form-horizontal" role="form" action="search_backend.php" method="post" style="background-image:url(back/05.jpg);">
<br><br>
						...
						<input type="text" value="1" name="check" style="display:none">
						...
						<div style="margin-top:10px" class="form-group">
							...
							<div class="col-sm-12 controls">
								<input type="submit" id="btn-login" action="search_backend.php" class="btn btn-success" value="Search"></a>
							</div>
						</div>
