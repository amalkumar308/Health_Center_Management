...
<nav class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="col-sm-12" >
				<h2 style="opacity: 0.8;"><marquee><label align="center" style="color:#FFFFFF;opacity:1px;">ADMIN <?php echo " \"$userid\"";?>  CAN YOU SURE TO DELETE DATA ?</label></marquee></h2>
				<hr>
	<br><br><br><br>
<div class="container">    
            <div class="col-sm-12" >
                      ...
                      <?php
                        ...
                        echo "<caption style='color:#D7DA0F '> Availebel Doctors</capiton>";
                         ...
                         while($row=$result->fetch_array())
                           {
                            $a=1;
                            echo "<tr style=' border-left: 6px solid red; color:#D7DA0F' align='center'><form action='delete_backend.php' method='post'><td>Dr. $row[2] $row[3] $row[4]</td><td>$row[6]</td><td>$row[5]</td><td>$row[7]<br>$row[8]<br>$row[9]</td><td>$row[10]</td>
                            <td>              <div class='col-sm-12 controls'>
                <input type='text' value='$row[0]' style='display:none' name='id'><input type='submit' id='btn-login' action='book.php' class='btn btn-success' value='Delete Doctor'></a>
              </div></td></form></tr>";
                           }
                       echo "</table>";
