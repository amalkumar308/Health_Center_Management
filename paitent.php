...
<nav class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="col-sm-12" >
				<h2 style="opacity: 0.8;"><marquee><label align="center" style="color:#FFFFFF;opacity:1px;">WELCOME  ADMIN <?php echo " \"$userid\"";?>  NOW YOU MANEGE THE DATA</label></marquee></h2>
				<hr>
	<br><br><br><br>
<div class="container">    
            <div class="col-sm-12" >
              <div style="color:#red  ;background-color:#071d36;opacity: 0.9; ">
                      ...
                      <?php
                        ...
                        echo "<caption style='color:#D7DA0F '> Patient Details</capiton>";
                         ...
                         while($row=$result->fetch_array())
                           {
                            $a=1;
                            echo "<tr style=' border-left: 6px solid red; color:#D7DA0F' align='center'><form action='book.php' method='post'><td>$row[1] $row[2] $row[3]</td><td>$row[5]</td><td>$row[4]</td><td>$row[6]<br>$row[7]<br>$row[8]</td><td>$row[9]</td></tr>";
                           }
                       echo "</table>";

                       if($a==0)
                        echo "<div align='center' class='col-sm-12 controls' style='color:#D7DA0F  ;background-color:#071d36;opacity: 0.8; '><b>No Doctor Aveilabel</b></div>";
                      ?>
